...
ittefaq_data <- read_csv("/Users/bahauddinsakib/Downloads/ittefaq_news_cleaned.csv")
View(ittefaq_data)
...
write_csv(ittefaq_data_named, "/Users/bahauddinsakib/Downloads/ittefaq_news_with_named_topics.csv")
